...
/**
 * TODO replace code by regexp expressions, so there is no need for another enum
 * 
 * @author Sebastian
 *
 */
public enum ModifierCode {
	...
	RESISTANCE_COLD("rc"),
	RESISTANCE_FIRE("rf"),
	RESISTANCE_POISON("rp"),
	RESISTANCE_ANDERMAGIC("ra"),
	RESISTANCE_LIGHT("rl"),
	BLOCK_REDUCTION("br"),
	MAXIMUM_DAMAGE("dmax"),
	MINIMUM_DAMAGE("dmin"),
	...
	TRAVEL_SPEED("ts"),
	ATTACK_SPEED("as"),
	WEAPON_ATTACK_SPEED("was"),
	BLOCK_STRENGTH("bs"),
	EXTRA_WEAPON_DMG("wde"),
	WEAPON_DAMAGE_MIN("wdmin"),
